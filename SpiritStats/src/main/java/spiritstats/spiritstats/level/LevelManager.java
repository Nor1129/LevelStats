...
public class LevelManager {
    ...
    public static final double HP_PER_LEVEL = 5.0;
    ...
    private static PlayerLevelData load(UUID uuid) {
        ...
        d.setLevel(Math.min(MAX_LEVEL, yml.getInt("level", 0)));
        d.setExp(yml.getInt("exp", 0));
        d.setLevelHpBonus((int) yml.getDouble("levelHpBonus", 0.0));
    ...
    public static void save(UUID uuid) {
        ...
        yml.set("levelHpBonus", d.getLevelHpBonus());
